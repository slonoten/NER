...
def make_rel_ext_inputs(words: List[List[str]],
    ...
    for sent_words, sent_pos_tags, sent_deps, br1, br2 in \
        ...
        inputs.append([word_indices, pos_tag_indices, br1_pad, br2_pad])  # dep_indices,
...
def gather(layer_input: List[Any]) -> Any:
    ...
    print(value_tensor.shape, pad_tensor.shape)
...
def build_rel_ext_model(num_classes, embed_matrix, pos_classes_num):
    ...
    branch_1_input = gather_layer([bilstm_out, branch_1_indices])
    ...
    branch_2_input = gather_layer([bilstm_out, branch_2_indices])
    ...
    model = Model([words_indices_input, pos_tag_indices_input, branch_1_indices, branch_2_indices], fc_out)
